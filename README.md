...
A light, macOS-inspired theme for [Omarchy](https://omarchy.org).

![Cupertino](preview.png)
...
```bash
omarchy theme install https://github.com/jonnyace/omarchy-cupertino-theme.git
```
...
```
~/.config/omarchy/backgrounds/cupertino/
```
